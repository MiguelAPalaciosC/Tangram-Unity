...
public class GridGenerateS<TListObject> : MonoBehaviour
{
    ...
    private int _width;
    private int _height;
    public GridGenerateS(int _width, int _height, int cellSize, GameObject cuadro, List<Transform> snaps)
    {
        this._width = _width;
        ...
        for (int i = 0; i < _width; i++)
        {
            ...
            {
                snaps.Add(Instantiate(cuadro, new Vector2((i + 0.5f), (j + 0.5f)), Quaternion.identity).transform);
            }
        }
    }
